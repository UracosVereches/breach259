--[[
lua/weapons/scarab/shared.lua
--]]
CustomizableWeaponry:registerAmmo("4mm sabot SCAR", "4mm sabot SCAR", 7.62, 39)
AddCSLuaFile()
AddCSLuaFile("sh_sounds.lua")
include("sh_sounds.lua")

if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/scrab")
	...
	SWEP.DrawTraditionalWorldModel = false
	 SWEP.WM = "models/cw2/weapons/w_cam_scab.mdl"
	...
	SWEP.IronsightPos = Vector(-2.131, -1.42, 0.69)
	SWEP.IronsightAng = Vector(0.275, 0, 0)
	...
	SWEP.EoTech552Pos =  Vector(-2.106, 0.014, 0.81)
	SWEP.EoTech552Ang = Vector(0, 0, 0)

	SWEP.CoD4TascoPos = Vector(-2.136, -0.63, 0.962)
	SWEP.CoD4TascoAng = Vector(0, 0, 0)

	SWEP.AimpointPos = Vector(-2.092, -1.285, 0.416)
	SWEP.AimpointAng = Vector(0, 0, 0)
	
	SWEP.MicroT1Pos = Vector(-2.129, -1.107, 0.834)
	SWEP.MicroT1Ang = Vector(-0, 0, 0)
	
	SWEP.CoD4ReflexPos = Vector(-2.142, -1.723, 0.767)
	SWEP.CoD4ReflexAng = Vector(-0.109, 0, 0)	
	...
	SWEP.AttachmentModelsVM = {
		...
		["md_cod4_eotech_v2"] = {model = "models/v_cod4_eotech.mdl", bone = "body", rel = "", pos = Vector(-0.895, -2.358, -0.044), angle = Angle(180, -1.02, -90), size = Vector(0.477, 0.477, 0.477)},
		["md_cod4_reflex"] = {model = "models/v_cod4_reflex.mdl", bone = "body", rel = "", pos = Vector(-0.528, -2.152, -0.02), angle = Angle(0, 180, 90), size = Vector(0.555, 0.555, 0.555)},
		["md_cod4_aimpoint_v2"] = {model = "models/v_cod4_aimpoint.mdl", bone = "body", rel = "", pos = Vector(-0.015, -2.136, -0.03), angle = Angle(0, -180, 90), size = Vector(0.559, 0.559, 0.559)},
		...
		["md_saker"] = {model = "models/cw2/attachments/556suppressor.mdl", bone = "body", rel = "", pos = Vector(6.678, -2.984, -1.918), angle = Angle(0, 90, 0), size = Vector(0.625, 0.625, 0.625)},
		["md_microt1"] = {model = "models/cw2/attachments/microt1.mdl", bone = "body", rel = "", pos = Vector(1.438, -4.049, -0.044), angle = Angle(90, -90, 0), size = Vector(0.246, 0.246, 0.246)}
	}
...
SWEP.Attachments = {[1] = {header = "0ptics", offset = {200, -200}, atts = {"md_microt1"}},
	[2] = {header = "Barrel", offset = {-300,-100}, atts = {"md_saker"}},
	[3] = {header = "Perks", offset = {1000, 00}, atts = {"pk_sleightofhand", "pk_light"}},
...
if CustomizableWeaponry_KK_HK416 then
  ...
  table.insert(SWEP.Attachments[1].atts, 4, "md_cod4_aimpoint_v2")  
end
...
SWEP.Sounds = {draw = {{time = 0, sound = "CW_FOLEY_MEDIUM"}},
	...
	reload = {[1] = {time = 0.35, sound = "CW_SCAB_MAGOUT"},
	[2] = {time = 1.3, sound = "CW_SCAB_MAGIN"},
	[3] = {time = 1.8, sound = "CW_SCAB_BOLTPULL"}}}
...
SWEP.ViewModel		= "models/cw2/weapons/v_cam_scab.mdl"
SWEP.WorldModel		= "models/cw2/weapons/w_cam_scab.mdl"
...
SWEP.FireSound = "CW_SCAB_FIRE"
SWEP.FireSoundSuppressed = "CW_SCAB_FIRE_SUPPRESSED"
SWEP.Recoil = 0.65
