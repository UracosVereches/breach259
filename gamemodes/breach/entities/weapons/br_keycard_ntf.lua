--[[
gamemodes/breach/entities/weapons/br_keycard_ntf.lua
--]]
AddCSLuaFile()

if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/card_ntf")
...
function SWEP:SetKeycardType( t )
	...
	elseif t == "ntf" then
		if CLIENT then
			self.PrintName = "Ключ-карта НТФ"
			self.WepSelectIcon = surface.GetTextureID( "vgui/entities/card_ntf.vmt" )
		else
			self:SetNWInt( "SKIN", 11 )
		end
		self:SetSkin( 11 )
		acc = "11000111111"
