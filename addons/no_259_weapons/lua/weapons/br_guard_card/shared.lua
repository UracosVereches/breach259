--[[
lua/weapons/br_guard_card/shared.lua
--]]
if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/card_guard")
	SWEP.BounceWeaponIcon = false
end

SWEP.Base				= "tfa_ccard_base"
...
SWEP.PrintName				= "ID Карта охранника"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Spread		= .00					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
SWEP.WorldModel			= "models/weapons/w_tfa_starshiptroopers_ucfadmin.mdl" -- Weapon world model path
...
SWEP.RunSightsAng = Vector (-30,0,0) --Change this, using SWEP Creation Kit preferably
