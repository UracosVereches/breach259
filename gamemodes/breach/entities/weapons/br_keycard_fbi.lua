--[[
gamemodes/breach/entities/weapons/br_keycard_fbi.lua
--]]
AddCSLuaFile()

if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/card_fbi")
...
function SWEP:SetKeycardType( t )
	...
	elseif t == "fbi" then
		if CLIENT then
			self.PrintName = "Ключ-карта ФБР"
			self.WepSelectIcon = surface.GetTextureID( "vgui/entities/card_fbi.vmt" )
		else
			self:SetNWInt( "SKIN", 10 )
		end
		self:SetSkin( 10 )
		acc = "11000111111"
