--[[
gamemodes/breach/entities/weapons/br_keycard_2.lua
--]]
AddCSLuaFile()

if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/card_lvl2")
...
SWEP.PrintName		= "Ключ-карта 2-ого уровня"
SWEP.Slot			= 1
SWEP.SlotPos		= 1
SWEP.DrawAmmo		= false
