--[[
gamemodes/breach/gamemode/cl_classmenu.lua
--]]
CLASSMENU = nil
...
function OpenClassMenu()
    ...
    CLASSMENU.Paint = function( self, w, h )
        ...
        surface.SetMaterial(Material("snyargyha.png"))

        surface.SetDrawColor(255, 255, 255)

        surface.DrawTexturedRect(0, 0, w, h)

        draw.SimpleText("Менеджер классов", "MTF_Main", 10, 0, Color(255, 255, 255))
    ...
    local close_butt = vgui.Create("DButton", CLASSMENU)

    close_butt:SetPos(CLASSMENU:GetWide() - 30, 0)

    close_butt:SetSize(30, 20)

    close_butt:SetText("")

    close_butt.DoClick = function()

        CLASSMENU:Close()

    end

    close_butt.Paint = function(self, w, h)

        draw.RoundedBox(0, 0, 0, w, h, Color(255, 51, 51))
    ...
    if selectedclass.showmodel == nil then
        ...
        smodel = selectedclass.models[math.random(1, #selectedclass.models)]
    ...
    sclass_name.Paint = function( self, w, h )
        ...
        draw.RoundedBox( 2, 1, 1, w - 2, h - 2, Color(50, 50, 50, 100) )
    ...
    sclass_name.Paint = function( self, w, h )
        ...
        surface.DrawTexturedRect(w - 75, h - 75, 75, 75)

        surface.SetMaterial(Material("material/red.png"))

        surface.SetDrawColor(255, 255, 255)

        surface.DrawTexturedRect(135, starpos - 9, math.Clamp(selectedclass.health, 0, 200), 20)

        surface.SetDrawColor(200, 200, 200, 200)

        surface.DrawOutlinedRect(135, starpos - 9, 200, 20)

        draw.SimpleText(selectedclass.health, "MTF_Third", w / 2 - 15, starpos, Color(255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)

        draw.Text( {

            text = "Скорость ходьбы: " .. math.Round(100 * selectedclass.walkspeed),
        ...
        draw.Text( {
            ...
            text = "Скорость бега: " .. math.Round(210 * selectedclass.runspeed),
        ...
        draw.Text( {
            ...
            text = "Сила прыжка: " .. math.Round(190 * selectedclass.jumppower),
    ...
    maininfo:SetTextColor(Color(255, 255, 255))
    ...
    for key,v in pairs(ALLCLASSES) do
        ...
        for i,cls in ipairs(v.roles) do
            ...
            if cls.showmodel == nil then
                ...
                model = cls.models[math.random(1, #cls.models)]
