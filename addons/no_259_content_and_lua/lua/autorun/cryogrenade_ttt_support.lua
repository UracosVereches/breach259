--[[
addons/lua_crap/lua/autorun/cryogrenade_ttt_support.lua
--]]
...
hook.Add("Initialize", "CRYO_TTTSUPPORT", function()
	...
	local function AddSupport()
		...
		local BaseClass = baseclass.Get("ttt_basegrenade_proj")
		...
		local BaseClass = baseclass.Get("weapon_tttbasegrenade")
