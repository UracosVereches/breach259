--[[
lua/weapons/br_med/shared.lua
--]]
if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/card_med")
...
SWEP.PrintName				= "ID Карта Медика"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel			= "models/weapons/w_tfa_starshiptroopers_psiopsofficer.mdl"  -- Weapon world model path
