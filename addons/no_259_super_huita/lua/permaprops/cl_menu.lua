--[[
addons/super_huita/lua/permaprops/cl_menu.lua
--]]
/*
...
local function breach_perma_menu()
	...
	ClearMapProps.DoClick = function()
		...
		Derma_Query("Are you sure you want clear map props in the db ?\nYou can't undo this action !", "PermaProps 4.0", "Yes", function() net.Start("breach_perma_send") net.WriteTable({CMD = "DEL_MAP"}) net.SendToServer() end, "Cancel")
	...
	ClearAllProps.DoClick = function()
		...
		Derma_Query("Are you sure you want clear all props in the db ?\nYou can't undo this action !", "PermaProps 4.0", "Yes", function() net.Start("breach_perma_send") net.WriteTable({CMD = "DEL_ALL"}) net.SendToServer() end, "Cancel")
...
net.Receive("breach_perma_menu", breach_perma_menu)
