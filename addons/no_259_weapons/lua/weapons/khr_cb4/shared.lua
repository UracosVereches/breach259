--[[
lua/weapons/khr_cb4/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/elephant")
...
SWEP.Attachments = {[3] = {header = "Sight", offset = {-350, -550},  atts = {"md_makeshift", "md_schmidt_shortdot", "md_uecw_csgo_acog", "md_nightforce_nxs"}},
	...
	["+reload"] = {header = "Ammo", offset = {300, -550}, atts = {"am_4borehp"}}
