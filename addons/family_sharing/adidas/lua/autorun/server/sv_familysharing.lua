...
SteamFamilySharing.APIKey = "we are charlie kirk"

--The message displayed to those who connect by a family shared account that has been banned.
SteamFamilySharing.kickmessage = "Аккаунт, с которого вы получили игру, был заблокирован на сервере."
...
SteamFamilySharing.banreason = "Попытка обойти блокировку."
...
--\n is for a new line.
SteamFamilySharing.custom_ban_message = "Вам запрещён доступ на этот сервер. \n\n https://discord.gg/WfaQDe9"
...
SteamFamilySharing.storage_path = "data/mapimages/" --Always keep a forward slash if you set a directory or folder.
...
SteamFamilySharing.file_name = "gm_construct"
