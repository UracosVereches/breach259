...
if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/snav_u")
			...
			if v:IsPlayer() then
				...
				if v:GTeam() != TEAM_SPEC then
					...
					elseif v:GTeam() == TEAM_SCI then
						...
						continue
					elseif v:GTeam() == TEAM_DZ then
						if lp:GTeam() == TEAM_DZ then
						  table.ForceInsert(self.warnings, self.Lang.dzdetect)
							continue
						else
							table.ForceInsert(self.warnings, self.Lang.resdetect)
							continue
						end
					elseif v:GTeam() == TEAM_GOC then
						if lp:GTeam() == TEAM_GOC then
							table.ForceInsert(self.warnings, self.Lang.gocdetect)
						  continue
						else
