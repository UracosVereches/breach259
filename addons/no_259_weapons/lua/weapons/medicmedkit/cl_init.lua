--[[
lua/weapons/medicmedkit/cl_init.lua
--]]
...
net.Receive("ReloadingprogressMedkit", function()
	...
	function pb_medkitframe:Paint(w, h)
			...
			if pb_medkits > 90 then
				...
				draw.SimpleText("Лечение...", "DermaDefault", 10, 1, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP);
	...
	pb_medkiticon.Paint = function( self, w, h )
		...
		surface.SetMaterial(Material("vgui/entities/first_aid")) --Icon for medicpackicon
	...
	timer.Create("UsingMedkit" ..ply:SteamID(), 0.065, 0, function()
...
net.Receive("CloseProgressBar", function()
