--[[
gamemodes/breach/entities/entities/armor_sci_med.lua
--]]
AddCSLuaFile()
...
ENT.PrintName	= "Одежда медика"

ENT.ArmorType	= "armor_sci_med"
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/cultist/items/sci_medic.mdl")
...
function ENT:Use(ply)
	...
	if ply:GetModel() == "models/scp_class_d/class_d_new_1.mdl" or ply:GetModel() == "models/scp_class_d/class_d_hacker_new.mdl" then -- hackerman fix
		...
		ply:SetModel("models/scp_sci_new/med_new_1.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_2.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_2.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_3.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_3.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_4.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_4.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_5.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_5.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_6.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_6.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_7.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_7.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_8.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_8.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_9.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_9.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_10.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_10.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_11.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_11.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_12.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_12.mdl")

	elseif ply:GetModel() == "models/scp_class_d/class_d_new_13.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_13.mdl")

	--Д бабы

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_01.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_01.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_02.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_02.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_03.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_03.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_04.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_04.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_05.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_05.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_06.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_06.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_07.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_07.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_08.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_08.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_09.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_09.mdl")

	elseif ply:GetModel() == "models/scp_class_d/female/d_female_10.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_10.mdl")

	-- Бабы ученые

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_01.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_01.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_02.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_02.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_03.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_03.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_04.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_04.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_05.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_05.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_06.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_06.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_07.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_07.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_08.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_08.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_09.mdl" then

		ply:SetModel("models/scp_sci_new/female/m_female_09.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/female/s_female_10.mdl" then
	...
	elseif ply:GetModel() == "models/scp_sci_new/sci_new_1.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_1.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_2.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_2.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_3.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_3.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_4.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_4.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_5.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_5.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_6.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_6.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_7.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_7.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_8.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_8.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_9.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_9.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_10.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_10.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_11.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_11.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_12.mdl" then

		ply:SetModel("models/scp_sci_new/med_new_12.mdl")

	elseif ply:GetModel() == "models/scp_sci_new/sci_new_13.mdl" then
