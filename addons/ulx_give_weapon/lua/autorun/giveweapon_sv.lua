--[[
addons/ulx_give_weapon/lua/autorun/giveweapon_sv.lua
--]]
if SERVER then
local YOUR_VERSION = "1.08"
local PLY2 = "102"
local ADDON_NAME = "give_wep"
local ADDON_ACTUAL_NAME = "ulx_give_weapon"
local DOWNLOAD_LINK = "http://goo.gl/GMeBY7"
local MESSAGE_TO_SERVER = "APPLE'S ULX GIVE WEAPON"
