--[[
gamemodes/breach/entities/weapons/weapon_breach_basemelee.lua
--]]
AddCSLuaFile()
...
function SWEP:StartMoaningSound()
	self:GetOwner():EmitSound("NPC_BaseZombie.Mdan"..math.random(4))
end

function SWEP:PlayHitSound()
	self:EmitSound("npc/zombie/sha"..math.random(3)..".wav", nil, nil, nil, CHAN_AUTO)
end

function SWEP:PlayMissSound()
	self:EmitSound("npc/zombie/na"..math.random(2)..".wav", nil, nil, nil, CHAN_AUTO)
end

function SWEP:PlayAttackSound()
	self:EmitSound("npc/zombie/huh"..math.random(2)..".wav")
end
