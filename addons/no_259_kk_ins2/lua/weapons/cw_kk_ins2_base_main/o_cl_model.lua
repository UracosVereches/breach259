...
if self:GetOwner() == TEAM_SPEC then return end
	...
	if IsValid(self.Owner) then
		...
		if self.OwnerAttachBoneID == nil then return end
		
		if EntGetBoneMatrix(self.Owner, self.OwnerAttachBoneID) == nil then return end
