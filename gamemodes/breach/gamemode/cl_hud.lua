...
hook.Add( "HUDPaint", "Breach_DrawHUD", function()
	...
	if POS_914B_BUTTON != nil then

		if LocalPlayer():GetPos():DistToSqr(POS_914B_BUTTON) < 40000 then

			if buttonstatus != nil or STATUS_914[buttonstatus] != nil then
				DrawInfo(POS_914B_BUTTON, STATUS_914[buttonstatus], Color(255,255,255))
			end
