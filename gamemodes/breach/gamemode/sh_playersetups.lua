--[[
gamemodes/breach/gamemode/sh_playersetups.lua
--]]
ROLES.ROLE_INFECTD = "Class D"
...
function SetupMultiBreach( pltab )
	...
	local specialspawns = table.Copy(SPAWN_SCIENT)

	for i=1, pltab[5] do

		if #specialspawns < 1 then

			specialspawns = table.Copy(SPAWN_SCIENT)
		...
		if #specialspawns > 0 then
			...
			local spawn = table.Random(specialspawns)
			...
			print("assigning " .. pl:Nick() .. " to special researcher")
