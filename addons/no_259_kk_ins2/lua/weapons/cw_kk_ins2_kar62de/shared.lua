--[[
lua/weapons/cw_kk_ins2_kar62de/shared.lua
--]]
...
if CLIENT then
	...
	SWEP.IronsightPos = Vector(-3.3, -3, 0.5)
  SWEP.IronsightAng = Vector(0.2652, 0.0073, 0)

	SWEP.KKINS2KobraPos = Vector(-3.3, -3, -1)
...
SWEP.ViewModel		= "models/weapons/cultist/v_scp_kar98.mdl"
SWEP.WorldModel		= "models/weapons/cultist/w_scp_kar98.mdl"
