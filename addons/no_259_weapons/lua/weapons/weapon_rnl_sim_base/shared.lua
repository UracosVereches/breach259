--[[
lua/weapons/weapon_rnl_sim_base/shared.lua
--]]
...
--SWEP.Category			= "Siminov's Base RNL"
...
function SWEP:Precache()
    ...
    util.PrecacheSound("weapons_rnl/universal/uni-draw.wav")
	util.PrecacheSound("weapons_rnl/universal/uni-grab.wav")
	util.PrecacheSound("weapons_rnl/universal/uni-holster.wav")
	util.PrecacheSound("weapons_rnl/universal/uni-ironidle.wav")
	util.PrecacheSound("weapons_rnl/universal/uni-ironin.wav")
	util.PrecacheSound("weapons_rnl/universal/uni-ironout.wav")
	util.PrecacheSound("weapons_rnl/universal/uni-pistol-empty.wav")
	util.PrecacheSound("weapons_rnl/universal/uni-quickmove.wav")	
	util.PrecacheSound("weapons_rnl/universal/uni-rifle-empty.wav")	
end
/*---------------------------------------------------------
	...
	if (self.Owner) then
		if (b) then
			if (self.Weapon:Clip1() == 0) then
				self.Weapon:SendWeaponAnim(ACT_DOD_PRIMARYATTACK_MP44)
			else
			...
			if (self.Weapon:Clip1() == 0) then
				...
				self.Weapon:SendWeaponAnim(ACT_DOD_STAND_ZOOM_BOLT)
			else
	...
	if (self.Owner) then
		if (b) then
			...
			if self.AllowIdleAnimation then
				...
				if (self.Weapon:Clip1() == 0) then
					self.Weapon:SendWeaponAnim(ACT_DOD_RELOAD_PSCHRECK)
				else
...
function SWEP:ShootEffects()
	...
	timer.Simple(0, function()
		...
		util.Effect("effect_sim_gunsmoke_rnl", effectdata)
	end)
	end
...
function SWEP:ShootAnimation()
	...
	if (self.Weapon:Clip1() == 0) then
		self.Weapon:SendWeaponAnim(ACT_DOD_PRONE_ZOOM_BOLT)
	else
...
AmmoTypes["thirtyoddsix"] = 30
AmmoTypes["eightmmgerman"] = 30
AmmoTypes["thirtycarbine"] = 22
