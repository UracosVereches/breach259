--[[
lua/weapons/br_sci_med/shared.lua
--]]
if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/card_sci")
...
SWEP.PrintName				= "ID Карта Ученого"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel			= "models/weapons/w_tfa_starshiptroopers_psiopstroop.mdl" -- Weapon world model path
