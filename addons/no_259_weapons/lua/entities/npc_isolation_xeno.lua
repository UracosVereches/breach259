--[[
lua/entities/npc_isolation_xeno.lua
--]]
--[[ Apache License --
...
function ENT:Initialize()
	...
	if SERVER then
		...
		self:SetHealth( sk_alien_health:GetInt() )
...
function ENT:CheckForEnemy()
	...
	table.sort( viewCone, function( a1, a2 )
		...
		if a1:GetPos():Distance( self:GetPos() ) < a2:GetPos():Distance( self:GetPos() ) then return false end
		return true
	end )
