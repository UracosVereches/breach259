...
SWEP.ViewModel = "models/weapons/melee/scp/v_katana.mdl"
SWEP.WorldModel = "models/weapons/melee/scp/v_katana.mdl"
...
SWEP.WElements = {
	["sword"] = { type = "Model", model = "models/weapons/melee/scp/w_katana.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.719, 1.939, -1.162), angle = Angle(180, 180, 0), size = Vector(1.016, 1.016, 1.016), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
if !IsValid(self) or !IsValid(self.Owner) then return end
	...
	pain = self.Primary.Damage * damagedice
				if SERVER and IsValid(self.Owner) then
						...
						slash.mins = Vector(-14, -15, -15)
						slash.maxs = Vector(15, 15, 15)
						local slashtrace = util.TraceHull(slash)
						if slashtrace.Hit then
							targ = slashtrace.Entity
							if targ:IsPlayer() or targ:IsNPC() or targ:GetClass() == "func_breakable" then
							    if targ:GTeam() == TEAM_SCP then return end
