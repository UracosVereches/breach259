--[[
gamemodes/breach/entities/weapons/br_keycard_9.lua
--]]
AddCSLuaFile()

if CLIENT then
	SWEP.WepSelectIcon 	= surface.GetTextureID("vgui/entities/card_goc")
...
SWEP.PrintName		= "Ключ-карта ГОКа"
SWEP.Slot			= 1
SWEP.SlotPos		= 1
SWEP.DrawAmmo		= false
